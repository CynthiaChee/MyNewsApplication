...
public class celebNewsFragment extends Fragment {
    ...
    public celebNewsFragment() {}

    public static celebNewsFragment newInstance(String param1, String param2) {
        celebNewsFragment fragment = new celebNewsFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view =inflater.inflate(R.layout.fragment_celebnews, container, false);

        RecyclerView recyclerView = view.findViewById(R.id.verticalRecyclerCeleb);
