...
public class politicsNewsFragment extends Fragment {
    ...
    public static politicsNewsFragment newInstance(String param1, String param2) {
        politicsNewsFragment fragment = new politicsNewsFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view =inflater.inflate(R.layout.fragment_politicsnews, container, false);

        RecyclerView recyclerView = view.findViewById(R.id.verticalRecyclerPol);
